...
# compute23's/compute10's concurrent LAST runs over the same NFS mount.
cd /home/yeochan.yoon/caliper-stress-test-c25

export JAVA_HOME="/home/yeochan.yoon/jdk17-portable"
export PATH="${JAVA_HOME}/bin:/home/yeochan.yoon/node22/bin:${PATH}"

# Fixed binary: reorderHybridWithWeights() O(n log n) comparator-recompute
# bug patched here 2026-08-28 (see run_prep_scheduler_fix_n5_c10.sh for full
# history) -- the original besu-mats (unpatched) must NOT be used here.
...
# Continuation of the original 25-run job (RUN_ID fixed, not regenerated):
# last_hfl_1, mats_1, mats_raw_1 already completed and preserved under this
# RUN_ID; this script does reps 2-5 for those same 3 variants only.
# baseline and last_wsa were moved to a fresh n=5 on compute10 instead
# (see run_mats_eval_besu_c10.sh) since compute10 freed up and this gives a
# more balanced split (this host does 3 variants x 4 reps = 12 remaining
# runs; compute10 does 2 variants x 5 reps = 10 fresh runs).
RUN_ID="20260831_153407_mats_eval_besu"
...
# ── Main loop ─────────────────────────────────────────────────────────────────
echo "======================================================================"
echo "MATS Eval Besu CONTINUATION | 150 TPS | 120s+300s"
echo "Variants: last_hfl, mats, mats_raw | Reps 2-5 (rep1 already done)"
echo "Run ID: ${RUN_ID}"
echo "Results: ${RESULTS_DIR}"
echo "======================================================================"
echo "Starting 12 runs..."
...
echo ""
echo "======================================================================"
echo "Continuation COMPLETE (last_hfl/mats/mats_raw all at n=5)."
echo "Results: ${RESULTS_DIR}"
echo "======================================================================"
